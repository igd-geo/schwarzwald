 ...
 */
AABB
get_bounds_from_node_name(const std::string& node_name,
 ...
 */
AABB
get_root_bounds_from_node(OctreeNodeIndex64 node_index,
...
AABB
get_bounds_from_morton_index(const DynamicMortonIndex& morton_index,
                             const AABB& root_bounds);

AABB
get_bounds_from_node_index(const OctreeNodeIndex64& node_index,
                           const AABB& root_bounds);
...
void
calculate_morton_indices_for_points(
             ...
             OutlierPointsBehaviour outlier_points_behaviour)
{
  std::transform(points_begin,
                 ...
                 [&bounds, outlier_points_behaviour](
                   ...
                   return index_point<MaxLevels>(
                     point_reference, bounds, outlier_points_behaviour);
                 });
}
...
partition_points_into_child_octants(Iter begin,
                                    Iter end,
