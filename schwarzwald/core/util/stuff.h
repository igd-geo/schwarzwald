...
/**
 * Helper function for adding C++ strings to rapidjson objects
 */
template<typename Allocator>
rapidjson::Value
rj_string(const std::string& str, Allocator& alloc)
{
  if (str.size() > std::numeric_limits<rapidjson::SizeType>::max()) {
    throw std::runtime_error{
      "String size exceeds rapidjson::SizeType max value"
    };
  }
