...
boundingRegionFromAABB(const AABB& aabb, const Potree::SRSTransformHelper& transformHelper)
{
  ...
  transformHelper.transformPositionsTo(Potree::TargetSRS::WGS84, gsl::make_span(vertices));
...
static BoundingBox
boundingBoxFromAABB(const AABB& aabb, const Potree::SRSTransformHelper& transformHelper)
{
