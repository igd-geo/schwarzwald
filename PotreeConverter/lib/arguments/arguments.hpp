...
template<>
vector<string>
AValue::as<vector<string>>(vector<string> alternative)
{
...
template<>
vector<double>
AValue::as<vector<double>>(vector<double> alternative)
{
  vector<double> res;
  for (auto& v : values) {
...
template<>
double
AValue::as<double>(double alternative)
{
