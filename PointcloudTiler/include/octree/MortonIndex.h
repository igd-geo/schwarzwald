...
/**
 * Converts a MortonIndex into a string representation of the node index. This is a concatenation
...
/**
 * Takes strings of the form '03465273' and converts them into MortonIndex objects.
