...
{
public:
  PNTSWriter(const std::string& filePath, const PointAttributes& pointAttributes);
  ~PNTSWriter();
...
/// <summary>
/// When transforming positions in a .pnts file, should they be recentered with their origin at
/// the smallest point?
/// </summary>
enum class Recenter
{
...
/// <summary>
/// Takes the given 3D-Tiles .pnts file and converts its point position using the given
/// SRSTransformHelper. If desired, recenters the points to the smallest point and updates
/// the RTC_CENTER property of the .pnts file
/// </summary>
void
